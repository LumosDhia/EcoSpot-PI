...
*   **Dynamic Content Translation**: Integrated **Google Translate API** (via `TranslationService`) with **caching** to automatically translate dynamic content like categories and tags.
...
*   **Blog Writing Interface**: Complete redesign of the article creation/editing UI, for more clarity.
*   **Taxonomy System**: Implemented the core system for **Categories** and **Tags** with dedicated admin management.
*   **User Filtering**: Added functionality to filter and browse blog articles by **Writer**, **Category**, or **Tag**.
...
*   **Notification bundle**: **SweetAlert2** creat, modify, delete, paticipate in en event will be notified.
